/**
 * Copy from https://github.com/espressif/esp-idf/blob/master/components/ulp/ulp_fsm/ulp_macro.c
 * 
 * Modify to load any size of ULP program.
*/

#define HULPx_CONFIG_ULP_COPROC_RESERVE_MEM     8192        // Max RTC_SLOW_MEM
...
esp_err_t HULPx_process_macros_and_load(uint32_t load_addr, const ulp_insn_t* program, size_t* psize)
{
    ...
    const size_t ulp_mem_end = HULPx_CONFIG_ULP_COPROC_RESERVE_MEM /sizeof(ulp_insn_t);
